  ...
  return (
    <div className="flex" onClick={handleIsInstruct}>
      {isAuthenticated ? (
          ...
          >
            ...
            {streakPopup &&
              ReactDOM.createPortal(
                <div className="streak-popup  ml-8 md:ml-72">
                  <FadeUpContainer direction="down" delay={0.6}>
                    <div
                      className=" flex items-center border-4 p-2 lg:p-6 rounded-xl bg-darkBackground"
                      ref={streakRef}
                    >
                      <FontAwesomeIcon
                        icon={faCircleCheck}
        ...
        <div className="bg-purpleSidebar border-2 border-purpleNormal rounded-3xl   mr-10 w-full">
